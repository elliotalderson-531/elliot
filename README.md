...
F-DECRYPTOR is an Shell Script to perform multi-threaded brute force attack against Instagram, this script can bypass login limiting and it can test infinite number of passwords with a rate of about 1000 passwords/min with 100 attemps at once.
...
### Usage:
```
git clone https://github.com/elliotalderson-531/elliot
cd elliot
chmod +x fdecryptor.sh
sudo ./fdecryptor.sh
```
